...
export const SYSTEM_TABLES: Omit<TableStatus, 'exists' | 'rowCount' | 'lastSync' | 'error'>[] = [
  ...
  { table: 'urunler',           displayName: 'Urunler',          icon: '\u{1F4E6}' },
  ...
  { table: 'tahsilatlar',       displayName: 'Tahsilatlar',      icon: '\u{1F4B3}' },
  { table: 'stok_hareketleri',  displayName: 'Stok Hareketleri', icon: '\u{1F4CA}' },
];
